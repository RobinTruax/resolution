...
local files = require('filesys.files')
    ...
    pickers.new(opts, {
        ...
        attach_mappings = function(prompt_bufnr, map)
            actions.select_default:replace(function()
                ...
                states.active_project_path = trim_path(selection['value']['filepath'])
                vim.cmd('cd ' .. states.active_project_path)
                files.file_menu()
            end)
            return true
        end,
