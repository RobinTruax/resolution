...
computation.symbols_for_sympy = {
    -- letters
    'a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,t,s,u,v,w,x,y,z,A,B,C,D,E,F,G,H,J,K,L,M,N,O,P,Q,R,T,S,U,V,W,X,Y,Z',
    -- letters with single-digit subscripts
    'a:10,b:10,c:10,d:10,e:10,f:10,g:10,h:10,i:10,j:10,k:10,l:10,m:10,n:10,o:10,p:10,q:10,r:10,t:10,s:10,u:10,v:10,w:10,x:10,y:10,z:10,A:10,B:10,C:10,D:10,E:10,F:10,G:10,H:10,J:10,K:10,L:10,M:10,N:10,O:10,P:10,Q:10,R:10,T:10,S:10,U:10,V:10,W:10,X:10,Y:10,Z:10',
    -- greek letters
...
computation.default_kernels = {
    { name = 'SymPy', cmd = 'python3', file = 'rsltn_sympy.py', desc = 'Full support' },
