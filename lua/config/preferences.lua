...
prefs.project_root_path              = '/home/roshan/Documents/Mathematics/'                -- where projects are stored
prefs.format_style_file              = vim.fn.stdpath('config') .. '/tex/format-style.yaml' -- style file for formatting LaTeX
prefs.dictionary_files               = {                                                    -- dictionary files
    vim.fn.stdpath('config') .. '/tex/dictionary/proof-of-concept.txt'
}

--------------------- vimtex configuration ----------------------

glb.vimtex_view_sioyek_exe         = '/home/roshan/Applications/Sioyek.AppImage' -- where to look for PDF viewer
glb.vimtex_view_method             = 'sioyek'                                    -- type of PDF viewer
glb.vimtex_quickfix_ignore_filters = {                                           -- warnings to ignore
    'Underfull',
    'Overfull',
    'requested',
    "removing `math shift'",
